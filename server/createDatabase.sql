...
insert into employment values
	('Electrical Meter Reader','Spotless Group','Jan 2017 - Present','My current employment has built my skills in rapid accurate data entry. This is conducted on specialized hardware and software to ensure fluid collection and mobility. \nI have utilized this work to further develop my personal time management while being innovative to increase my productivity','Maintaining and operation of data capturing hardware{}Independent time management{}Data entry'),
    ('Bombardier','Australian Army','Dec 2009 - Dec 2016','I served in the Australian defence force after leaving high school to give myself the opportunity to exercise my discipline and leadership. While serving I was promoted to the position of Bombardier and became the second in command of a section of soldiers. This required contribution from me to maximize the effectiveness of my team to execute tasks to achieve the desired outcome. \nThis experience cultivated strong work ethics and team dynamics that I can bring to any future employment','Training military personnel on equipment, weaponry, vehicles and communications devices{}Development of a fire team to execute military tactics{}Administration of a fire team for combat readiness');
unlock tables;
